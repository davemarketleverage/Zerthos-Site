...
export const DivSubsection = () => {
  ...
  return (
    <section ref={ref} className="relative w-full bg-[#202020]">
      ...
      <div className={`w-full h-[400px] sm:h-[480px] md:h-[520px] lg:h-[560px] bg-[url(https://c.animaapp.com/mcovvnm5V0Fxtk/img/bg-mask-group.png)] bg-[100%_100%] transition-all duration-1000 ease-out will-change-transform will-change-opacity ${hasAnimated ? 'translate-y-0 opacity-100 visible' : 'translate-y-12 opacity-0 invisible'}`}>
        <div className="flex flex-col lg:flex-row w-full max-w-[1344px] items-start gap-6 sm:gap-8 md:gap-12 lg:gap-40 relative top-[100px] sm:top-[120px] md:top-[140px] lg:top-[180px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
